...
const Home = () => {
  return (
    <div className="overflow-x-hidden bg-gray-50 sm:h-auto h-[83vh]">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="">
            <h1 className="mt-5 inline max-w-sm text-3xl font-bold leading-snug text-gray-900 sm:text-6xl sm:leading-snug lg:text-7xl lg:leading-snug">
              Transforma. Comprime. Eleva. <br className="hidden sm:block" />
              <span className="text-blue-600"> Optimiza</span>
            </h1>
            <p className="inline-block max-w-2xl sm:mt-0 mt-9 text-base leading-7 text-gray-600">
              Tus imágenes con nuestra potente herramienta en línea. Convierte
              tus imágenes a formato WebP para una carga más rápida y ahorra
              espacio sin comprometer la calidad. Nuestra tecnología de
              compresión avanzada garantiza que tus imágenes sean más ligeras,
              manteniendo la nitidez y los detalles.
            </p>
            <div className="group relative mt-10 flex">
              <Link
                to={`/Upload-Api-ImgBb/${uuidv4()}`}
